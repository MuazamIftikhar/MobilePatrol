...
<table style="width: 100% !important;  border: none; border-collapse: collapse !important;margin-bottom: 10px">
    <tr>
        <td style="text-align:center !important;font-size: 24px"><b class="headerSmall" style="text-decoration: underline">ATTENDANCE REPORT</b></td>
    </tr>
</table>
<div>
    @include('manager.report.pdf.splits.attendance')
</div>
