                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="radio-inline">
                            <label class="radio">
                                <input type="radio" name="some-radios" value="shift" v-if = "form_type === 'shift'" checked v-model="form_type">Shift
                                <span></span></label>
                            <label class="radio">
                                <input type="radio" name="some-radios" value="regular" v-if = "form_type === 'regular'" checked v-model="form_type">Regular
                                <span></span></label>
                        </div>
                        <span v-show="errors.description"
...
//                    {name: "file", id: 6 ,label : "Enter file" , required : "true" , placeholder : "Enter file"},
        ...
        methods: {
            ...
            updated_at(){
                ...
                if (self.form_type == ''){self.errors.form_type = true;return false;}else {self.errors.form_type = false}
